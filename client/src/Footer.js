...
export default class Footer extends React.Component {
    render() {
        ...
        return (
            ...
            <div class="d-flex row" id="footer">
                <div class="col-md">
                    <small>Copyright 2019</small>
                </div>
                <div class="col-md" id="contact">
                    <p>Contact Us </p>
                    <a id="social" href="..." aria-label="Facebook" target="_blank">
                        <svg height="40px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112.2 112.2" >
                            <circle class="st0" cx="56.1" cy="56.1" r="56.1" />
                            <path class="st1" style={fb} d="M70.2,58.3h-10V95H45V58.3h-7.2V45.4H45v-8.3c0-6,2.8-15.3,15.3-15.3l11.2,0v12.5h-8.2c-1.3,0-3.2,0.7-3.2,3.5
                            v7.6h11.3L70.2,58.3z" />
                        </svg>
                    </a>
                    <a id="social" href="mailto:sburd36@uw.edu" aria-label="Send Email">
                        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 0 612 612">
                            <path class="st0" style={email} d="M306,612c-28.2,0-55.3-3.7-81.4-11c-26.1-7.3-50.5-17.6-73.1-30.9s-43.2-29.2-61.8-47.7
